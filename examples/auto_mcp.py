...
# AutoMCP is now an alias for DynMCP for backward compatibility
class AutoMCP(DynMCP):
    """
    AutoMCP automatically exposes all public methods of a class instance as MCP endpoints.
    ...
    Note: AutoMCP is now an alias for DynMCP for backward compatibility.
    ...
    Example:
        ...
        # Create AutoMCP instance
        calc = Calculator()
        auto_mcp = AutoMCP(calc, server_name="Calculator Server")
...
if __name__ == "__main__":
    # Example class to demonstrate AutoMCP
    class Calculator:
